...
?>   
 <div class="header-search floatright">
        <?php
            $data_advik_blog_lite_str = '{"content":';
            $data_advik_blog_lite_str .= '{"effect": "fadein", "fullscreen": true, "speedIn": 300, "speedOut": 300, "delay": 300},'; 
            $data_advik_blog_lite_str .= '"loader":';    
            $data_advik_blog_lite_str .= '{"active": true}';     
            $data_advik_blog_lite_str .= '}';
        ?>
        <a class="advik-blog-lite-link" href="javascript:void(0);" data-advik-blog-lite-1='<?php echo esc_attr($data_advik_blog_lite_str);?>'><i class="fa fa-search"></i></a>       
