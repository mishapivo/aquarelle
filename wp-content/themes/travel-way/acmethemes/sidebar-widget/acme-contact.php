...
if ( ! class_exists( 'Travel_Way_Contact' ) ) {
    ...
    class Travel_Way_Contact extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'shortcode' ); ?>"><?php esc_html_e( 'Enter Shortcode', 'travel-way' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'page_id' ); ?>"><?php esc_html_e( 'Select Page For Contact', 'travel-way' ); ?>:</label>
                <br />
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'single_page_content_from' ); ?>"><?php _e( 'Page Content From', 'travel-way' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'single_page_content_number' ); ?>"><?php _e( 'Number of page words in content', 'travel-way' ); ?>:</label>
                <br/>
                <small>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'background_options' ); ?>"><?php esc_html_e( 'Background Options', 'travel-way' ); ?>:</label>
