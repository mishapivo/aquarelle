...
function zita_scripts(){
	...
	wp_enqueue_style( 'zita-menu-style', get_template_directory_uri() . '/css/zita-menu.css', '', '4.7.0' );
	wp_enqueue_style( 'zita-style', get_stylesheet_uri(), array(), '1.0.2' );
    ...
    wp_enqueue_script( 'zita-custom-js', get_parent_theme_file_uri().'/js/custom.js', array( 'jquery' ), '', true );
