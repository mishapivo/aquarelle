...
function galway_lite_get_default_theme_options() {
	...
	$defaults['slider_section_layout']         = 'twp-slider-5';
	$defaults['button_text_on_slider']         = esc_html__('Read More', 'minimal-travelogue');
    $defaults['primary_font'] = 'Playfair+Display:400,400italic,700,900';
	...
	$defaults['read_more_button_text']    = esc_html__('Continue Reading', 'minimal-travelogue');
	...
	$defaults['copyright_text']           = esc_html__('Copyright All right reserved', 'minimal-travelogue');
