...
function edupress_customize_register( $wp_customize ) {
	...
	$wp_customize->add_panel( 'edupress_panel', array(
		...
		'theme_supports' => '',
		'title'          => esc_html__( 'Theme Options', 'edupress' ),
		'description'    => esc_html__( 'EduPress Theme Options', 'edupress' ),
	) );

	$wp_customize->add_section( 'edupress_header_options', array(
		'title'		  => esc_html__( 'Header', 'edupress' ),
		'panel'		  => 'edupress_panel',
	) );

		// Featured Categories checkbox
		$wp_customize->add_setting( 'edupress_header_display_tagline', array(
			'default'           => 1,
			'sanitize_callback' => 'edupress_sanitize_checkbox',
		) );

		$wp_customize->add_control( 'edupress_header_display_tagline', array(
			'label'             => esc_html__( 'Display site title and tagline in the header.', 'edupress' ),
			'section'           => 'edupress_header_options',
			'type'              => 'checkbox',
		) );

	$wp_customize->add_section( 'edupress_front_page', array(
		'title'		  => esc_html__( 'Featured Content Blocks', 'edupress' ),
		'panel'		  => 'edupress_panel',
	) );
		...
		$wp_customize->add_control( 'edupress_featured_page_1', array(
			...
			'description'		=> sprintf( wp_kses( __( 'This list is populated with <a href="%1$s">Pages</a>.', 'edupress' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( admin_url( 'edit.php?post_type=page' ) ) ),
			'section'           => 'edupress_front_page',
			'type'              => 'select',
	...
	$wp_customize->add_section( 'edupress_other_options', array(
		'title'		  => esc_html__( 'Other Options', 'edupress' ),
		'panel'		  => 'edupress_panel',
	) );
