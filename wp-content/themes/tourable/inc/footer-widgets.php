...
class Tourable_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'tourable';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'tourable' ), $i ),
...
// Initialize.
$tourable_footer_widgets = new Tourable_Footer_Widgets();
