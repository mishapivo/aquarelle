...
if ( ! class_exists( 'Lifestyle_Magazine_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Lifestyle_Magazine_Demo {

		/**
		 * Singleton instance of Lifestyle_Magazine_Demo.
		 *
		 * @var Lifestyle_Magazine_Demo $instance Lifestyle_Magazine_Demo instance.
		 */
		...
		/**
		 * Main Lifestyle_Magazine_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Lifestyle_Magazine_Demo ) ) {
				self::$instance = new Lifestyle_Magazine_Demo();
