...
class Firm_Graphy_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'firm_graphy';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'firm-graphy' ), $i ),
...
// Initialize.
$firm_graphy_footer_widgets = new Firm_Graphy_Footer_Widgets();
