...
function yp_yellow_penci_bar() {
	...
	$liveLink = add_query_arg(array('yp_live_preview' => 'true', 'yp_page_id' => intval($_GET['yp_page_id']), 'yp_page_type' => trim(strip_tags($_GET['yp_page_type'])), 'yp_rand' => rand(1000, 9999)),$hrefNew);
    ...
    echo "<div class='yp-select-bar yp-disable-cancel'>
		...
		echo "<div class='yp-customizing-section'>
				...
				<div id='customizing-type-list'><ul>".yp_customizing_options()."</ul></div></h3>
				</div>
		</div>";
