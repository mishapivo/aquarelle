 ...
 */
$wp_customize->add_setting('zita_above_mobile_set', array(
        'default'        => 'inline',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'esc_attr',
    ));
$wp_customize->add_control( 'zita_above_mobile_set', array(
        'settings' => 'zita_above_mobile_set',
...
$wp_customize->add_control(new Zita_Misc_Control( $wp_customize, 'zita_abv_header_doc_learn_more',
        ...
        'section'     => 'zita-above-header',
        'type'        => 'custom_message',
        'description' => sprintf( wp_kses(__( 'To know more Go with this <a target="_blank" href="%s">Doc</a> !', 'zita' ), array(  'a' => array( 'href' => array(),'target' => array() ) ) ), esc_url('https://wpzita.com/docs/above-header/')),
         'priority'   =>50,
    )));