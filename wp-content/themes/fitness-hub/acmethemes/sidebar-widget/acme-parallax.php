 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Fitness_Hub_Feature' ) ) {

	class Fitness_Hub_Feature extends WP_Widget {
		...
		private function defaults(){
			...
			$defaults = array(
				...
				'sub_title'         => '',
				'bg_image'          => '',
				'button_one_text'   => esc_html__( 'Book Now', 'fitness-hub' ),
				'button_one_url'    => '',
				'button_two_text'   => esc_html__( 'Learn More', 'fitness-hub' ),
				'button_two_url'    => ''
			);
			return $defaults;
		}
		...
		function __construct() {
			parent::__construct(
                    ...
                    esc_html__('AT Feature Section', 'fitness-hub'),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show Parallax Section.', 'fitness-hub' )
                    )
			);
		}
		...
		public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'sub_title' ); ?>"><?php _e( 'Short Description', 'fitness-hub' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'button_one_text' ); ?>"><?php esc_html_e( 'Extra Button Text', 'fitness-hub' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'button_one_url' ); ?>"><?php esc_html_e( 'Button Link Url', 'fitness-hub' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'button_two_text' ); ?>"><?php esc_html_e( 'Extra Button Text', 'fitness-hub' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'button_two_url' ); ?>"><?php esc_html_e( 'Button Link Url', 'fitness-hub' ); ?></label>
	...
	} // Class Fitness_Hub_Feature ends here
}