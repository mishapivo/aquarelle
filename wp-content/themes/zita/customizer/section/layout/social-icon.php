...
// COLOR OPTION
$wp_customize->add_setting('zita_divide_social_set', array(
    'sanitize_callback' => 'zita_sanitize_text',
    ));
$wp_customize->add_control(new Zita_Misc_Control( $wp_customize, 'zita_divide_social_set',
            array(
        'section'     => 'zita-social-icon',
        'type'        => 'custom_message',
        'description' => __('Setting','zita' ),
    )));
//Enable Loader
...
$wp_customize->add_control(new Zita_Misc_Control( $wp_customize, 'zita_social_link_more',
        ...
        'section'     => 'zita-social-icon',
        'type'        => 'custom_message',
        'description' => sprintf( wp_kses(__( 'To know more Go with this <a target="_blank" href="%s">Doc</a> !', 'zita' ), array(  'a' => array( 'href' => array(),'target' => array() ) ) ), esc_url('https://wpzita.com/docs/social-icon/')),
        'priority'   =>30,
    )));