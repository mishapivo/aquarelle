...
$wp_customize->add_control( new Simple_Days_html_text_Custom_Content( $wp_customize, 'simple_days_header_setting_fontawsome_icon_info', array(
  ...
  'content' => '<a href="'.esc_url('https://fontawesome.com/v4.7.0/icons/').'" target="_blank">'.__( 'FontAwesome 4 Icon List' , 'simple-days').'</a><br /><br />'.'<a href="'.esc_js('javascript:wp.customize.section(\"simple_days_option\").focus();' ).'">'.esc_html__( 'You need full icons?', 'simple-days' ).'</a>',
...
while($i <= 10){
  ...
  $wp_customize->add_control( new Simple_Days_Color_Alpha_Custom_Control( $wp_customize, 'simple_days_menu_bar_h_icon_color_'.$i, array(
...
while($i <= 10){
  ...
  $wp_customize->add_control( new Simple_Days_Color_Alpha_Custom_Control( $wp_customize, 'simple_days_menu_bar_f_icon_color_'.$i, array(
