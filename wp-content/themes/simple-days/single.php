...
<?php while ( have_posts() ) : the_post();
  ...
  <div class="container m_con jc_c retaina_p0">
    <main id="post-<?php the_ID(); ?>" <?php post_class('contents post_content f_box f_col box_shadow'.$single_column); ?> itemprop="mainContentOfPage" itemscope="itemscope" itemtype="https://schema.org/Blog">

      <?php

      get_template_part( 'template-parts/post','order' );
      simple_days_post_order($type = 'post' , $single_sortable , $post_title_effects , $post);
      ?>
