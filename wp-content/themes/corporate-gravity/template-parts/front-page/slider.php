		...
		<div class="home-slider owl-carousel">
			<?php
				...
				while ( $query->have_posts() ) : $query->the_post();
					$image = business_gravity_get_thumbnail_url( array( 'size' => 'business-gravity-1920-1200' ) );
			?>
					    			...
					    			<div class="col-12 col-lg-8 offset-lg-2 col-md-10 offset-md-1 text-center">
					    				<div class="slide-inner">
					    					<div class="post-content-inner-wrap">
					    						...
					    						<div class="content">
						    					<?php  
						    						business_gravity_excerpt( 15, true );
						    					?>
					    						</div>
					    						<?php  
							    				...
							    				<div class="button-container">
							    					<a href="<?php the_permalink(); ?>" class="button-primary">
							    						<?php esc_html_e( 'Learn More', 'corporate-gravity' ); ?>
							    					</a>
							    					<?php if( !business_gravity_get_option( 'disable_slider_button' ) ): ?>
