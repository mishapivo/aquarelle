...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'xcel' ),
		'cyrillic'     => __( 'Cyrillic', 'xcel' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'xcel' ),
		'devanagari'   => __( 'Devanagari', 'xcel' ),
		'greek'        => __( 'Greek', 'xcel' ),
		'greek-ext'    => __( 'Greek Extended', 'xcel' ),
		'khmer'        => __( 'Khmer', 'xcel' ),
		'latin'        => __( 'Latin', 'xcel' ),
		'latin-ext'    => __( 'Latin Extended', 'xcel' ),
		'vietnamese'   => __( 'Vietnamese', 'xcel' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'xcel' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'xcel' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'xcel' ),
