...
<div class="col-xs-12 mesmerize-add-section-wrapper middle-xs">
    <div class="border mesmerize-add-section-wrapper-inner">
        <button data-install-companion-button="true" class="button blue"><?php esc_html_e('Add Section', 'one-page-express'); ?></button>
        <script>
            (function () {
                jQuery(function () {
                    jQuery('[data-install-companion-button="true"]').click(function () {
                        var w = window.parent;
                        w.tb_show('Mesmerize Companion', '#TB_inline?width=400&height=430&inlineId=one_page_express_homepage');
