...
if ( ! class_exists( 'Firm_Graphy_Latest_Post' ) ) :

     
    class Firm_Graphy_Latest_Post extends WP_Widget {
        /**
        ...
        public function __construct() {
            $tp_widget_popular_post = array(
                ...
                'description' => esc_html__( 'Retrive latest posts.', 'firm-graphy' ),
            );
            parent::__construct( 'firm_graphy_latest_post', esc_html__( 'TP : Latest Posts', 'firm-graphy' ), $tp_widget_popular_post );
        }
        ...
        public function form( $instance ) {
            $tp_title      = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Latest Posts', 'firm-graphy' );
            $tp_number     = isset( $instance['number'] ) ? absint( $instance['number'] ) : 3;
           ?>
           ...
           <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show:', 'firm-graphy' ); ?></label>
