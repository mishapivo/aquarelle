 ...
 */
$wp_customize->add_setting('zita_bottom_mobile_set', array(
        'default'        => 'inline',
        'capability'     => 'edit_theme_options',
        'sanitize_callback' => 'esc_attr',
    ));
$wp_customize->add_control( 'zita_bottom_mobile_set', array(
        'settings' => 'zita_bottom_mobile_set',
        'label'   => __('Mobile Header Alignment','zita'),
        'section' => 'zita-bottom-header',
        'type'    => 'select',
        'choices'    => array(
...
$wp_customize->add_control(new Zita_Misc_Control( $wp_customize, 'zita_below_header_doc_learn_more',
        ...
        'section'     => 'zita-bottom-header',
        'type'        => 'custom_message',
        'description' => sprintf( wp_kses(__( 'To know more Go with this <a target="_blank" href="%s">Doc</a> !', 'zita' ), array(  'a' => array( 'href' => array(),'target' => array() ) ) ), esc_url('https://wpzita.com/docs/below-header/')),
         'priority'   =>50,
    )));