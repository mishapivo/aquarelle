...
function diamond_scripts() {    
    ...
    wp_enqueue_script( 'diamond-mansory-grid', get_template_directory_uri() . '/js/mansory-grid.js', array(), '20150625', false );
...
add_action( 'tgmpa_register', 'diamond_register_required_plugins' );
function diamond_register_required_plugins() {
    $plugins = array(
        array(
