...
class EnspireTabs extends WP_Widget {

/*  Constructor
/* ------------------------------------ */
	function __construct() {
		parent::__construct( false, esc_html__( 'Alx Tabs', 'enspire' ), array('description' => esc_html__('List posts, comments, and/or tags with or without tabs.', 'enspire' ), 'classname' => 'widget_enspire_tabs', 'customize_selective_refresh' => true ) );
	}

	public function enspire_get_defaults() {
		return array(
			'title'				=> '',
			'tabs_category'		=> 1,
			'tabs_date'			=> 1,
...
/* ------------------------------------ */
	public function widget($args, $instance) {
		...
		$defaults = $this -> enspire_get_defaults();
					...
					<div class="tab-item-thumbnail">
						<a href="<?php the_permalink(); ?>">
							<?php if ( has_post_thumbnail() ): ?>
								<?php the_post_thumbnail('enspire-small'); ?>
							<?php else: ?>
...
?>
	...
	<div class="alx-options-tabs">
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('title') ); ?>"><?php esc_html_e( 'Title:', 'enspire' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" type="text" value="<?php echo esc_attr($instance["title"]); ?>" />
		</p>

		<h4><?php esc_html_e( 'Recent Posts', 'enspire' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('recent_enable') ); ?>"><?php esc_html_e( 'Enable recent posts', 'enspire' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('recent_thumbs') ); ?>"><?php esc_html_e( 'Show thumbnails', 'enspire' ); ?></label>
		</p>
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("recent_num") ); ?>"><?php esc_html_e( 'Items to show', 'enspire' ); ?></label>
		...
		<p>
			<label style="width: 100%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("recent_cat_id") ); ?>"><?php esc_html_e( 'Category:', 'enspire' ); ?></label>
			<?php wp_dropdown_categories( array( 'name' => $this->get_field_name("recent_cat_id"), 'selected' => $instance["recent_cat_id"], 'show_option_all' => esc_html__('All','enspire'), 'show_count' => true ) ); ?>
		</p>

		<hr>
		<h4><?php esc_html_e( 'Most Popular', 'enspire' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('popular_enable') ); ?>"><?php esc_html_e( 'Enable most popular posts', 'enspire' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('popular_thumbs') ); ?>"><?php esc_html_e( 'Show thumbnails', 'enspire' ); ?></label>
		</p>
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("popular_num") ); ?>"><?php esc_html_e( 'Items to show', 'enspire' ); ?></label>
		...
		<p>
			<label style="width: 100%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("popular_cat_id") ); ?>"><?php esc_html_e( 'Category:', 'enspire' ); ?></label>
			<?php wp_dropdown_categories( array( 'name' => $this->get_field_name("popular_cat_id"), 'selected' => $instance["popular_cat_id"], 'show_option_all' => esc_html__('All','enspire'), 'show_count' => true ) ); ?>
		</p>
		<p style="padding-top: 0.3em;">
			<label style="width: 100%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("popular_time") ); ?>"><?php esc_html_e( 'Post with most comments from:', 'enspire' ); ?></label>
			<select style="width: 100%;" id="<?php echo esc_attr( $this->get_field_id("popular_time") ); ?>" name="<?php echo esc_attr( $this->get_field_name("popular_time") ); ?>">
			  <option value="0"<?php selected( $instance["popular_time"], "0" ); ?>><?php esc_html_e( 'All time', 'enspire' ); ?></option>
			  <option value="1 year ago"<?php selected( $instance["popular_time"], "1 year ago" ); ?>><?php esc_html_e( 'This year', 'enspire' ); ?></option>
			  <option value="1 month ago"<?php selected( $instance["popular_time"], "1 month ago" ); ?>><?php esc_html_e( 'This month', 'enspire' ); ?></option>
			  <option value="1 week ago"<?php selected( $instance["popular_time"], "1 week ago" ); ?>><?php esc_html_e( 'This week', 'enspire' ); ?></option>
			  <option value="1 day ago"<?php selected( $instance["popular_time"], "1 day ago" ); ?>><?php esc_html_e( 'Past 24 hours', 'enspire' ); ?></option>
			</select>
		</p>

		<hr>
		<h4><?php esc_html_e( 'Recent Comments', 'enspire' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('comments_enable') ); ?>"><?php esc_html_e( 'Enable recent comments', 'enspire' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('comments_avatars') ); ?>"><?php esc_html_e( 'Show avatars', 'enspire' ); ?></label>
		</p>
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("comments_num") ); ?>"><?php esc_html_e( 'Items to show', 'enspire' ); ?></label>
		...
		<hr>
		<h4><?php esc_html_e( 'Tags', 'enspire' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tags_enable') ); ?>"><?php esc_html_e( 'Enable tags', 'enspire' ); ?></label>
		</p>

		<hr>
		<h4><?php esc_html_e( 'Tab Order', 'enspire' ); ?></h4>

		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("order_recent") ); ?>"><?php esc_html_e( 'Recent posts', 'enspire' ); ?></label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("order_popular") ); ?>"><?php esc_html_e( 'Most popular', 'enspire' ); ?></label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("order_comments") ); ?>"><?php esc_html_e( 'Recent comments', 'enspire' ); ?></label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("order_tags") ); ?>"><?php esc_html_e( 'Tags', 'enspire' ); ?></label>
		...
		<hr>
		<h4><?php esc_html_e( 'Tab Info', 'enspire' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tabs_category') ); ?>"><?php esc_html_e( 'Show categories', 'enspire' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tabs_date') ); ?>"><?php esc_html_e( 'Show dates', 'enspire' ); ?></label>
		</p>
...
/*  Register widget
/* ------------------------------------ */
if ( ! function_exists( 'enspire_register_widget_tabs' ) ) {

	function enspire_register_widget_tabs() {
		register_widget( 'EnspireTabs' );
	}

}
add_action( 'widgets_init', 'enspire_register_widget_tabs' );
