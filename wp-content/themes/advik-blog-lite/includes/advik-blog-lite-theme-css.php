 ...
 * @since 1.0
 */
function advik_blog_lite_theme_dynemic_css() {	

	// Menu bar Bg Color
	$menu_bar_bg_clr = advik_blog_lite_get_theme_mod( 'menu_bar_bg_clr' );
	 
	// Action to add theme dynemic CSS	// Menu bar Link Color
	$menu_bar_link_clr = advik_blog_lite_get_theme_mod( 'menu_bar_link_clr' );
	
	// Menu bar Link Hover Color
	$menu_bar_linkh_clr = advik_blog_lite_get_theme_mod( 'menu_bar_linkh_clr' );
	 
	// Heading Color
	$h1_clr = advik_blog_lite_get_theme_mod( 'h1_clr' );
	$h2_clr = advik_blog_lite_get_theme_mod( 'h2_clr' );
	$h3_clr = advik_blog_lite_get_theme_mod( 'h3_clr' );
	$h4_clr = advik_blog_lite_get_theme_mod( 'h4_clr' );
	$h5_clr = advik_blog_lite_get_theme_mod( 'h5_clr' );
	$h6_clr = advik_blog_lite_get_theme_mod( 'h6_clr' );	
	
	// Link Color
	$link_clr = advik_blog_lite_get_theme_mod( 'link_clr' );
	 
	// Link Hover Color
	$hover_link_clr = advik_blog_lite_get_theme_mod( 'hover_link_clr' );	

	//read more button
	$continue_read_clr 	= advik_blog_lite_get_theme_mod( 'continue_read_clr' );
	$continue_read_hvr_clr 	= advik_blog_lite_get_theme_mod( 'continue_read_hvr_clr' );

?>

<style>
.main-navigation ul li a{color:<?php echo esc_attr($menu_bar_link_clr); ?>;}
.header-search .search-field:focus, .header-search .search-field:active{color:<?php echo esc_attr($menu_bar_link_clr); ?>;}


.main-navigation .current-menu-item a, .header-content .advik-blog-lite-sn a:hover, .header-content .advik-blog-lite-sn a:focus, .header-content .advik-blog-lite-sn a:active{color:<?php echo esc_attr($menu_bar_linkh_clr); ?>;} 
...
add_action( 'wp_head', 'advik_blog_lite_theme_dynemic_css' );