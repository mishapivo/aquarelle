...
<main class="grid" id="main_section">
    <?php while (have_posts()) : the_post();
            ...
            <div class="" id="<?php echo esc_attr($post->ID); ?>" role="dialog">
                <div class="modal-dialog">
                
                  <!-- Modal content-->
                <div class="modal-content" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal"></button>
                      <h2 class="modal-title recipeTitle" itemprop="name"><?php the_title(); ?></h2>
                    </div>
                      <div class="dishImage"><?php the_post_thumbnail('full'); ?></div>
