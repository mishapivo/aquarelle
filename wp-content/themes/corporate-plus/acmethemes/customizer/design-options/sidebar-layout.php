...
$wp_customize->add_section( 'corporate-plus-design-sidebar-layout-option', array(
    ...
    'theme_supports' => '',
    'title'          => __( 'Default Page/Post Sidebar Layout', 'corporate-plus' ),
...
$wp_customize->add_control( 'corporate_plus_theme_options[corporate-plus-sidebar-layout]', array(
    'choices'  	=> $choices,
    'label'		=> __( 'Default Page/Post Sidebar Layout', 'corporate-plus' ),
    'description'=> __( 'Single Page/Post Sidebar', 'corporate-plus' ),
