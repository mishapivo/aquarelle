        ...
        foreach ( $this->sections as $panel_id => $sections ) {
            foreach ( $sections as $section ) {
                ...
                if( isset( $section['parent'] ) ){
                    ...
                    if( empty( $section['parent'] ) && ! ( ! empty( $section['type'] ) && 'Auxin_Customize_Link_Section' == $section['type'] ) ){
                        ...
                        $section_class = ! empty( $section['type'] ) ? $section['type'] : 'Auxin_Customize_Section';
    ...
    protected function add_control( $wp_customize, $field ){
        ...
        switch ( $field['type'] ) {
            ...
            case 'responsive_dimensions':
                $control_args['type'] = 'auxin_responsive_dimension';
