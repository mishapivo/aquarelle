...
$config = array(
	...
	'quick_links' => array(
		'theme_url' => array(
			...
			'url'  => 'https://wpcapsules.com/downloads/blog-kit/',
			),
		'demo_url' => array(
			'text' => esc_html__( 'View Demos','blog-kit' ),
			'url'  => 'https://wpcapsules.com/demo/blog-kit-demos/',
			),
		'documentation_url' => array(
			'text'   => esc_html__( 'View Documentation','blog-kit' ),
			'url'    => 'https://wpcapsules.com/documentation/blog-kit/',
			),
		'rate_url' => array(
		...
		'pro_url' => array(
			...
			'url'  => 'https://wpcapsules.com/downloads/blog-kit-pro/',
			'button' => 'primary',
			),
		),
	...
	'getting_started' => array(
		array(
			...
			'button_link'         => 'https://wpcapsules.com/documentation/blog-kit/',
			'is_button'           => false,
		...
		array(
			...
			'button_link'  			=> 'https://wpcapsules.com/downloads/blog-kit-pro/',
			'is_button'    			=> true,
			'recommended_actions' 	=> false,
			'is_new_tab'   			=> true,
		),
		...
		array(
			...
			'button_link'  			=> esc_url( 'https://wpcapsules.com/forums/forum/blog-kit/' ),
			'is_button'    			=> false,
			'recommended_actions' 	=> false,
			'is_new_tab'   			=> true,
		),
