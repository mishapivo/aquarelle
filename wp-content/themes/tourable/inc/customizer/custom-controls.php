 ...
 */
class Tourable_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Tourable_Dropdown_Category_Control extends WP_Customize_Control {
...
class Tourable_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Tourable_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="tourable-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Tourable_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Tourable_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="tourable-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'tourable' ); ?>" class="tourable-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Tourable_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
