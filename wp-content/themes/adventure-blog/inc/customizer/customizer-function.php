 ...
 */
class adventure_blog_Dropdown_Taxonomies_Control extends WP_Customize_Control
{
 ...
 * @see WP_Customize_Control
 */
class adventure_blog_Radio_Image_Control extends WP_Customize_Control
{
...
if (!function_exists('adventure_blog_is_select_page_slider')) :
     ...
     */
    function adventure_blog_is_select_page_slider($control)
    {
...
if (!function_exists('adventure_blog_is_select_cat_slider')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function adventure_blog_is_select_cat_slider($control)
    {
...
if (!function_exists('adventure_blog_sanitize_select')) :
     ...
     */
    function adventure_blog_sanitize_select($input, $setting)
    {
...
if (!function_exists('adventure_blog_sanitize_checkbox')) :
     ...
     */
    function adventure_blog_sanitize_checkbox($checked)
    {
...
if (!function_exists('adventure_blog_sanitize_positive_integer')) :
     ...
     */
    function adventure_blog_sanitize_positive_integer($input, $setting)
    {
...
if (!function_exists('adventure_blog_sanitize_dropdown_pages')) :
     ...
     */
    function adventure_blog_sanitize_dropdown_pages($page_id, $setting)
    {
...
if (!function_exists('adventure_blog_sanitize_image')) :
     ...
     */
    function adventure_blog_sanitize_image($image, $setting)
    {
...
if (!function_exists('adventure_blog_sanitize_number_range')) :
     ...
     */
    function adventure_blog_sanitize_number_range($input, $setting)
    {
 ...
 * @access public
 */
class adventure_blog_Customize_Section_Upsell extends WP_Customize_Section {
