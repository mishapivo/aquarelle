...
if ( ! function_exists( 'mohini_get_defaults' ) ) {
	/**
	 * Set default options
	 *
	 */
	function mohini_get_defaults() {
		$mohini_defaults = array(
			'hide_title' => '',
			'hide_tagline' => true,
			'top_bar_width' => 'full',
		...
		return apply_filters( 'mohini_option_defaults', $mohini_defaults );
	}
}

if ( ! function_exists( 'mohini_get_color_defaults' ) ) {
	/**
	 * Set default options
	 */
	function mohini_get_color_defaults() {
		$mohini_color_defaults = array(
			'top_bar_background_color' => '#222222',
			'top_bar_text_color' => '#11b267',
			'top_bar_link_color' => '#11b267',
			'top_bar_link_color_hover' => '#dddddd',
			'header_background_color' => '#222222',
			'header_text_color' => '',
			'header_link_color' => '',
			'header_link_hover_color' => '',
			'site_title_color' => '#11b267',
			...
			'fixed_side_content_text_color' => '#11b267',
			'fixed_side_content_link_color' => '#11b267',
			...
			'blog_header_title_color' => '#11b267',
			'blog_header_text_color' => '#ffffff',
			'blog_header_button' => '#ffffff',
			'blog_header_button_bg' => '#11b267',
			'blog_header_button_hover' => '#ffffff',
			'blog_header_button_hover_bg' => '#11b267',
			...
			'sidebar_widget_title_color' => '#11b267',
			'footer_widget_background_color' => '#eeeeee',
			'footer_widget_text_color' => '#222222',
			'footer_widget_link_color' => '#11b267',
			'footer_widget_link_hover_color' => '#222222',
			'footer_widget_title_color' => '#11b267',
			'footer_background_color' => '#222222',
			'footer_text_color' => '#ffffff',
			'footer_link_color' => '#11b267',
...
if ( ! function_exists( 'mohini_get_default_fonts' ) ) {
	 ...
	 */
	function mohini_get_default_fonts( $filter = true ) {
		$mohini_font_defaults = array(
		...
		if ( $filter ) {
			return apply_filters( 'mohini_font_option_defaults', $mohini_font_defaults );
		}

		return $mohini_font_defaults;
	}
}

if ( ! function_exists( 'mohini_spacing_get_defaults' ) ) {
	/**
	 ...
	 * @return array Option defaults.
	 */
	function mohini_spacing_get_defaults( $filter = true ) {
		$mohini_spacing_defaults = array(
			'top_bar_top' => '6',
			'top_bar_right' => '20',
			'top_bar_bottom' => '3',
			'top_bar_left' => '20',
		...
		if ( $filter ) {
			return apply_filters( 'mohini_spacing_option_defaults', $mohini_spacing_defaults );
		}

		return $mohini_spacing_defaults;
	}
}

if ( ! function_exists( 'mohini_get_default_color_palettes' ) ) {
	/**
	 * Set up our colors for the color picker palettes and filter them so you can change them.
	 *
	 */
	function mohini_get_default_color_palettes() {
		$palettes = array(
			'#11b267',
			'#222222',
			'#555555',
		...
		return apply_filters( 'mohini_default_color_palettes', $palettes );
	}
}

if ( ! function_exists( 'mohini_typography_default_fonts' ) ) {
	/**
	 * Set the default system fonts.
	 *
	 */
	function mohini_typography_default_fonts() {
		$fonts = array(
			'inherit',
			'System Stack',
		...
		return apply_filters( 'mohini_typography_default_fonts', $fonts );
	}
}

define( 'MOHINI_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Playfair+Display:regular,italic,700,700italic,900,900italic' );
