...
class IT_Company_Lite_Social_Widget extends WP_Widget {
	function __construct() {
		...
		// Base ID of your widget
			...
			__('Social Icon', 'it-company-lite'),
			// Widget description
...
// This is where the action happens
	public function widget( $args, $instance ) {
		...
		//echo __( 'Hello, World!', 'it-company-lite' );
	...
	public function form( $instance ) {
		...
		?>	
			...
			<p>
			<label for="<?php echo esc_attr($this->get_field_id('google')); ?>"><?php esc_html_e('Google+:','it-company-lite'); ?></label>
...
} // Class IT_Company_Lite_Social_Widget ends here
