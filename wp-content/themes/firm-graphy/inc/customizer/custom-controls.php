 ...
 */
class Firm_Graphy_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Firm_Graphy_Dropdown_Category_Control extends WP_Customize_Control {
...
class Firm_Graphy_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Firm_Graphy_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="firm-graphy-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Firm_Graphy_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Firm_Graphy_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="firm-graphy-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'firm-graphy' ); ?>" class="firm-graphy-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Firm_Graphy_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
