...
<div class="site-info">
	...
	<span class="footer-info-right">
		<?php echo esc_html_e(' | Theme by', 'writers-blogily') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'writers-blogily'); ?>"><?php echo esc_html_e(' SuperbThemes', 'writers-blogily') ?></a>
	</span>
