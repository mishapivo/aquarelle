  ...
  if ( !get_user_meta( $user_id, esc_html( $theme_data->get( 'TextDomain' ) ) . '_notice_ignore' ) ) {
    ...
    <div class="notice zita-notice">
      ...
      <p>
        ...
        printf( __( 'Visit our Zita options page to take full advantage of theme.', 'zita' ), esc_html( $theme_data->Name ), esc_url( admin_url( 'themes.php?page=zita' ) ) );
      ...
      <p>
        <a href="<?php echo esc_url( admin_url( 'themes.php?page=zita' ) ) ?>" class="button button-primary button-hero" style="text-decoration: none;">
          <?php
    ...
    /**
					...
					<p>
						<?php
							...
							printf(
								...
								esc_html__( 'Get amazing free websites with zita. As zita offers you ready to use  %2$s ', 'zita' ),
								self::$page_title,
		...
		static public function zita_welcome_page_knowledge_base_scetion(){
			...
			<div class="postbox">
				...
				<div class="inside">
					<p>
						<?php esc_html_e( 'Want to know how it works, take a look on this and get whole knowledge about Zita. Learn Zita', 'zita' ); ?>
					</p>
					<?php
					...
					printf(
						...
						'%1$s',
						! empty( $zita_knowledge_base_doc_link ) ? '<a href=' . esc_url( $zita_knowledge_base_doc_link ) . ' target="_blank" rel="noopener">' . esc_html( $zita_knowledge_base_doc_link_text ) . '</a>' :
				...
				<div class="inside">
					<p>
						...
						printf(
							...
							esc_html__( 'Join the community of generous Zita users.  Get connected, share opinion, ask questions and Help each other!', 'zita' ),
							self::$page_title
						);
						?>
					</p>
					...
					printf(
						...
						'%1$s',
						! empty( $zita_community_group_link ) ? '<a href=' . esc_url( $zita_community_group_link ) . ' target="_blank" rel="noopener">' . esc_html( $zita_community_group_link_text ) . '</a>' :
				...
				<div class="inside">
					<p>
						...
						printf(
							...
							esc_html__( 'We start with what the customer needs and we work backwards. You\'re absolutely free to contact us and zita team will be happy to help you.', 'zita' ),
							self::$page_title
						);
						?>
					</p>
					<?php
						...
						printf(
							...
							'%1$s',
							! empty( $zita_support_link ) ? '<a href=' . esc_url( $zita_support_link ) . ' target="_blank" rel="noopener">' . esc_html( $zita_support_link_text ) . '</a>' :
