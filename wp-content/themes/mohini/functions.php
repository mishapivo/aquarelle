...
define( 'MOHINI_VERSION', '1.0.0' );

if ( ! function_exists( 'mohini_setup' ) ) {
	add_action( 'after_setup_theme', 'mohini_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function mohini_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'mohini' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'mohini' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in mohini_smart_content_width()
		 */
...
define('MOHINI_THEME_URL','https://wpkoi.com/mohini-wpkoi-wordpress-theme/','mohini');
define('MOHINI_WPKOI_AUTHOR_URL','https://wpkoi.com/','mohini');
define('MOHINI_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/','mohini');
define('MOHINI_WORDPRESS_REVIEW','https://wordpress.org/support/theme/mohini/reviews/?filter=5','mohini');
define('MOHINI_DOCUMENTATION','https://wpkoi.com/docs/','mohini');