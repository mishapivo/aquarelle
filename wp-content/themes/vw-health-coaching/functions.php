...
function vw_health_coaching_scripts() {
	...
	wp_enqueue_script( 'vw-health-coaching-custom-scripts-jquery', get_template_directory_uri() . '/assets/js/custom.js', array('jquery') );
...
function vw_health_coaching_ie_stylesheet(){
	wp_enqueue_style('vw-health-coaching-ie', get_template_directory_uri().'/css/ie.css');
	wp_style_add_data( 'vw-health-coaching-ie', 'conditional', 'IE' );
}
add_action('wp_enqueue_scripts','vw_health_coaching_ie_stylesheet');
...
define('VW_HEALTH_COACHING_CREDIT','https://www.vwthemes.com/themes/free-health-coach-wordpress-theme/','vw-health-coaching');
