...
if (!function_exists('hypermarket_credits')):
    ...
    {
        echo '<p class="copyright space-top"><span>' . apply_filters('hypermarket_copyright_text', $content = '&copy; ' . get_bloginfo('name') . ' ' . date_i18n(__('Y','hypermarket'))) . ' <br /><a href="https://mirsna.net/" title="Толкование и значение сна" rel="nofollow" target="_blank">сонник</a></span>';
        echo '</p>';
    }
endif;
/**
