 ...
 */
    ...
    $wp_customize->add_control( new Simple_Days_Color_Alpha_Custom_Control( $wp_customize, 'simple_days_alert_box_color', array(
    ...
    $wp_customize->add_control( new Simple_Days_Color_Alpha_Custom_Control( $wp_customize, 'simple_days_alert_box_bg_color', array(
    ...
    $wp_customize->add_control( new Simple_Days_Color_Alpha_Custom_Control( $wp_customize, 'simple_days_alert_box_border_color', array(
