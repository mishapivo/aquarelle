 ...
 * @return array Files.
 */
function travel_gem_ocdi_files() {

	return array(
		array(
			'import_file_name'             => esc_html__( 'Theme Demo Content', 'travel-gem' ),
			'local_import_file'            => trailingslashit( get_template_directory() ) . 'ocdi/travel-gem.xml',
			'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'ocdi/travel-gem.wie',
			'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'ocdi/travel-gem.dat',
			),
		);
}

add_filter( 'pt-ocdi/import_files', 'travel_gem_ocdi_files', 99 );
 ...
 * @since 1.0.0
 */
function travel_gem_ocdi_after_import() {
...
add_action( 'pt-ocdi/after_import', 'travel_gem_ocdi_after_import' );
