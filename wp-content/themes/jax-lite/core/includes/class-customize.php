	...
	class Jaxlite_Customize_Info_Control extends WP_Customize_Control {
		...
		public function render_content() { ?>
            ...
            <div class="inside">
                ...
                <h2><?php esc_html_e('WordPress Support Service.','jax-lite');?></h2> 
    
                <p><?php esc_html_e("We are excited to announce the opening of our new Premium WordPress Support Service, to solve all technical issues like code issues, white screen issues, theme and plugin issues and much more.","jax-lite");?></p>

                <ul>
                
                    <li><a class="button purchase-button" href="<?php echo esc_url( 'https://www.themeinprogress.com/products/wordpress-services/?ref=2&campaign=jax-panel' ); ?>" title="<?php esc_attr_e('WordPress Support','jax-lite');?>" target="_blank"><?php esc_html_e('WordPress Support','jax-lite');?></a></li>
            ...
            <div class="inside">
                ...
                <p><?php _e("If you've opened a new support ticket from <strong>WordPress.org</strong>, please send a reminder to <strong>support@wpinprogress.com</strong>, to get a faster reply.","jax-lite");?></p>
