        ...
        if( wp.customize ){
            wp.customize.controlConstructor['auxin_group_typography'] = wp.customize.AuxinControl.extend({
                ...
                ready: function() {
                    ...
                    var control = this,
                        controllerWrapper = $('.aux-typo-controller');

                    controllerWrapper.each( function( index, el) {
                        var $el = $(el),
                            input = $el.find('.aux-typo-controller-input')[0],
                            container = $el.find('.aux-typo-controller-container')[0];
        ...
        if( wp.customize ){
            wp.customize.controlConstructor['auxin_responsive_slider'] = wp.customize.AuxinControl.extend({
                ...
                ready: function() {
                    ...
                    var control = this,
                        controllerWrapper = $('.aux-slider-controller');

                    controllerWrapper.each( function( index, el) {
                        var $el = $(el),
                            input = $el.find('.aux-slider-controller-input')[0],
                            container = $el.find('.aux-slider-controller-container')[0];
        ...
        if( wp.customize ){
            wp.customize.controlConstructor['auxin_responsive_dimensions'] = wp.customize.AuxinControl.extend({
                ...
                ready: function() {
                    ...
                    var control = this,
                        controllerWrapper = $('.aux-dimension-controller');

                    controllerWrapper.each( function( index, el) {
                        var $el = $(el),
                            input = $el.find('.aux-dimension-controller-input')[0],
                            container = $el.find('.aux-dimension-controller-container')[0];
                            OptionControls.inputAdapter( input, container);
