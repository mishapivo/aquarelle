...
class Materia_Customizer {
	public static function register( $wp_customize ) {
		...
		$wp_customize->add_setting(
			'materia_header_image_display_mode',
			array(
				'default'           => 'card',
		...
		$wp_customize->add_setting( 'materia_single_header_image',
			array(
				'default'           => 'on',
				'sanitize_callback' => 'materia_sanitize_on_off',
			)
		...
		$wp_customize->add_control(
			new materia_Button_Customize_Control(
				$wp_customize,
				'materia_upgrade',
				array(
