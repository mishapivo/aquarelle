...
if ( ! class_exists( 'Lifestyle_Magazine_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Lifestyle_Magazine_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'lifestyle-magazine-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'lifestyle-magazine-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
