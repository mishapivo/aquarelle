 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Fitness_Hub_Social' ) ) {

    class Fitness_Hub_Social extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                    ...
                    esc_html__('AT Social Section', 'fitness-hub'),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show Social Buttons.', 'fitness-hub' )
                    )
            );
        }
        ...
        public function form( $instance ) {
            ...
            <p>
                <?php
                printf( esc_html__( 'Add/Edit Social Icons from %1$s Here %2$s ', 'fitness-hub' ), '<a target="_blank" href="'.esc_url( admin_url( 'customize.php' ) ).'?autofocus[section]=fitness-hub-social-options'.'" class="button button-primary">','</a>' );
                ?>
            </p>
            <?php
        }
    ...
    } // Class Fitness_Hub_Social ends here
}