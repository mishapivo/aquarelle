<?php
/**
 * responsiveblogily Theme Customizer
 *
 ...
 */
function responsiveblogily_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
	$wp_customize->get_section('header_image')->title = __( 'Below Navigation Image', 'responsiveblogily' );

	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			'selector'        => '.site-title a',
			'render_callback' => 'responsiveblogily_customize_partial_blogname',
			) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'responsiveblogily_customize_partial_blogdescription',
			) );
	}
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header Background Color', 'responsiveblogily' ),
		'section'     => 'colors',
		'priority'   => 1,
...
add_action( 'customize_register', 'responsiveblogily_customize_register' );




if(! function_exists('responsiveblogily_customizer_css_final_output' ) ):
	function responsiveblogily_customizer_css_final_output(){
		?>
		...
		<?php }
		add_action( 'wp_head', 'responsiveblogily_customizer_css_final_output' );
		endif;
 ...
 * @return void
 */
function responsiveblogily_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function responsiveblogily_customize_partial_blogdescription() {
 ...
 */
function responsiveblogily_customize_preview_js() {
	wp_enqueue_script( 'responsiveblogily-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'responsiveblogily_customize_preview_js' );
