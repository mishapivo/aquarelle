...
if ( ! class_exists( 'Business_Cast_Widget_Helper' ) ) {
	 ...
	 * @version 1.0.1
	 */
	class Business_Cast_Widget_Helper extends WP_Widget {
			...
			switch ( $type ) {
				...
				case 'image':
					...
					<div class="widget-field-image">
						<label for="<?php echo esc_attr( $this->get_field_id( $key ) ); ?>"><?php echo esc_html( $field['label'] ); ?></label>
						<input type="button" class="button button-primary wh-image-picker" value="<?php esc_attr_e( 'Upload', 'business-cast' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'business-cast' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'business-cast' ); ?>" />
						...
						<input type="button" class="button button-secondary btn-image-remove" value="<?php esc_attr_e( 'Remove', 'business-cast' ); ?>" <?php echo ( empty( $value ) ) ? 'style="display:none;"' : ''; ?> />
