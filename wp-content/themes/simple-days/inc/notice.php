...
function simple_days_yahman_addons_notice() {
	...
	<div id="" class="updated simple_days_plugin_wrap">
		<h3 class="simple_days_notice_title"><?php esc_html_e('Welcome! Thank you for choosing the Simple Days Theme :)' , 'simple-days'); ?></h3>
		<p class="simple_days_notice_description"><?php echo sprintf( esc_html__( 'If you want to take full advantage of the options this theme has to offer, please install and activate %s.', 'simple-days' ), sprintf( '<strong>%s</strong>', 'YAHMAN Add-ons' ) ); ?><br />
