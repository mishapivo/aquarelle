...
if ( ! class_exists( 'Business_Cast_Demo' ) ) {
	 ...
	 * @version 1.0.1
	 */
	class Business_Cast_Demo {

		/**
		 * Singleton instance of Business_Cast_Demo.
		 *
		 * @var Business_Cast_Demo $instance Business_Cast_Demo instance.
		 */
		...
		/**
		 * Main Business_Cast_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Business_Cast_Demo ) ) {
				self::$instance = new Business_Cast_Demo();
