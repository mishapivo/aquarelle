 ...
 */
function bloggist_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
	$wp_customize->get_section('header_image')->title = __( 'Header Settings', 'bloggist' );
	$wp_customize->get_section('colors')->title = __( 'Background Color', 'bloggist' );

	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			'selector'        => '.site-title a',
			'render_callback' => 'bloggist_customize_partial_blogname',
			) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'bloggist_customize_partial_blogdescription',
			) );
	}

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_textcolor', array(
		'label'       => __( 'Logo Color', 'bloggist' ),
	...
	$wp_customize->add_section( 'navigation_settings', array(
		'title'      => __('Navigation Settings','bloggist'),
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_background_color', array(
		'label'       => __( 'Background Color', 'bloggist' ),
		'section'     => 'navigation_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_border_color', array(
		'label'       => __( 'Border Color', 'bloggist' ),
		'section'     => 'navigation_settings',
		'priority'   => 1,
...
add_action( 'customize_register', 'bloggist_customize_register' );




if(! function_exists('bloggist_customizer_css_final_output' ) ):
	function bloggist_customizer_css_final_output(){
		?>
		...
		<?php }
		add_action( 'wp_head', 'bloggist_customizer_css_final_output' );
		endif;
 ...
 * @return void
 */
function bloggist_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function bloggist_customize_partial_blogdescription() {
 ...
 */
function bloggist_customize_preview_js() {
	wp_enqueue_script( 'bloggist-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'bloggist_customize_preview_js' );
