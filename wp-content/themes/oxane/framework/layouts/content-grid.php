...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-12 col-sm-12 grid'); ?>>
		...
		<div class="featured-thumb col-md-4 col-sm-4">
			<?php if (has_post_thumbnail()) : ?>	
				<a href="<?php the_permalink() ?>" title="<?php the_title_attribute() ?>"><?php the_post_thumbnail('oxane-pop-thumb'); ?></a>
			<?php else: ?>
		...
		<div class="out-thumb col-md-8 col-sm-8">
			<header class="entry-header">
				...
				<div class="postedon"><?php oxane_posted_on(); ?></div>
				<span class="entry-excerpt"><?php the_excerpt(); ?></span>
				<span class="readmore"><a class="hvr-underline-from-center" href="<?php the_permalink() ?>"><?php _e('Read More','oxane'); ?></a></span>
			</header><!-- .entry-header -->
		</div><!--.out-thumb-->
