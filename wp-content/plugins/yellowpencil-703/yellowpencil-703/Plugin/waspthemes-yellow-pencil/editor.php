...
<body class="<?php echo $classesReturn; ?>">
	...
	<?php
		...
		$frame = add_query_arg(array('yellow_pencil_frame' => 'true','yp_page_type' => $type,'yp_page_id' => $id,'yp_mode' => $mode),$frameLink);
	...
	<div class="top-area-btn-group">
		...
		<div data-toggle='tooltip-bar' data-placement='right' title='CSS Editor <span class="yp-s-shortcut">(É)</span><span class="yp-tooltip-shortcut">Edit style codes.</span>' class="top-area-btn css-editor-btn"><span class="css-editor-icon"></span></span></div>
		...
		$(document).ready(function(){
	        ...
	        $('#iframe').on('load', function(){
				...
				var styles = [
					...
					"<?php $prtcl = is_ssl() ? 'https' : 'http'; echo $prtcl; ?>://fonts.googleapis.com/css?family=Roboto:400,500",
