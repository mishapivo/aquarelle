...
bootstrap-lightpress is distributed under the terms of the GNU General Public License v2


== Installation ==
	
1. In your admin panel, go to Appearance > Themes and click the Add New button.
2. Click Upload and Choose File, then select the bootstrap-lightpress.zip file. Click Install Now.
...
Bootstrap Photo is a child theme of "Bootstrap Blog". Bootstrap Photo Theme is licensed under the GPL v2. 
Bootstrap Photo WordPress Theme, Copyright 2018 The Bootstrap Themes
Bootstrap Photo is distributed under the terms of the GNU GPL
...
* Image licences Used in screenshot - https://unsplash.com/photos/1Dq56G9fBXs
Photo by Fancycrave on Unsplash

* Image licences Used in screenshot - https://unsplash.com/photos/gVwFedcc1rY
Photo by Dorian Mongel  on Unsplash

* Image licences Used in screenshot - https://unsplash.com/photos/4JpyAldl-KI
