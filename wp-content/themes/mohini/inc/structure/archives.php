...
if ( ! function_exists( 'mohini_archive_title' ) ) {
	add_action( 'mohini_archive_title', 'mohini_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function mohini_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * mohini_before_archive_title hook.
			 *
			 */
			do_action( 'mohini_before_archive_title' );
			?>
			...
			<?php
			/**
			 * mohini_after_archive_title hook.
			 *
			 */
			do_action( 'mohini_after_archive_title' );
			...
			/**
			 * mohini_after_archive_description hook.
			 *
			 */
			do_action( 'mohini_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'mohini_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'mohini_filter_the_archive_title' );
	/**
	 ...
	 */
	function mohini_filter_the_archive_title( $title ) {
		if ( is_category() ) {
