...
function zita_header_menu_style(){
          $zita_main_header_layout = get_theme_mod('zita_main_header_layout');
        	if($zita_main_header_layout =='mhdrleftpan' || $zita_main_header_layout =='mhdrrightpan' || $zita_main_header_layout =='mhdminbarleft'|| $zita_main_header_layout =='mhdminbarright'){
            $menustyle='accordion';
        	}else{
...
if($g_link = get_theme_mod('social_link_google','#')) :
