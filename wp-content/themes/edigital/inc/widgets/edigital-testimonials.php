<?php
/**
 * Widget for testimonials which shows the posts from selected category.
 *
 * @package Mystery Themes
 * @subpackage Edigital
 * @since 1.0.0
 */
add_action( 'widgets_init', 'edigital_register_testimonials' );

function edigital_register_testimonials() {
    register_widget( 'Edigital_Testimonials' );
}

class Edigital_Testimonials extends WP_Widget {
                    ...
                    <div class="section-items-wrapper">
                        <?php
                            if( $testimonials_query->have_posts() ) {
                                echo '<ul class="testimonialsSlider cS-hidden">';
                        ...
                        ?>
                                    <li>
                                        <div class="single-post-wrapper clearfix">
                                            ...
                                            <?php } ?>
                                            <div class="testimonial-conent-wrapper">
