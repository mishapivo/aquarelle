...
$options = array (
	...
	array(  "name" => "Настройка главной страницы",
            "type" => "title",
			"desc" => "",
        ),
	...
	array( 	"name" => "Логотип сайта",
			"desc" => "Введите URL логотипа",
			"id" => $shortname."_logo",
			"std" => get_bloginfo('template_directory')."/images/logo.png",
            "type" => "text"), 		
	
	
	array(  "name" => "Контент главной страницы",
			"desc" => "Выбор между списком товаров и традиционным блогом с постами",
			"id" => $shortname."_home",
            "type" => "select",		
			"options" => array('products', 'blog'),		
   		    "std" => ""),
	
	array(  "type" => "close"),
	
	
	array(  "name" => "Настройка слайдера",
            "type" => "title",
			"desc" => "",
        ),
	...
	array( 	"name" => "Число выводимых слайдов",
			"desc" => "Введите число слайдов",
	...
	array(  "name" => "Настройка социальных кнопок",
            "type" => "title",
    ...
    array(  "name" => "Настройка банеров",
            "type" => "title",
			"desc" => "This section customizes the custom ad banners.",
       		),
	   
	array(    "type" => "open"),
	
	array( 	"name" => "Header banner",
			"desc" => "Your banner code",
			"id" => $shortname."_topad",
			"std" => "",
            "type" => "textarea"), 
