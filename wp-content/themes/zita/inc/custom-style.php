...
$zita_style .= "a:hover,.inifiniteLoader,mark,.single .nav-previous:hover:before,.single .nav-next:hover:after,.page-numbers.current, .page-numbers:hover, .prev.page-numbers:hover, .next.page-numbers:hover,.zita-load-more #load-more-posts:hover,article h2.entry-title a:hover,.zita-menu li a:hover,.main-header .zita-menu > li > a:hover,.woocommerce nav.woocommerce-pagination ul li a:focus, .woocommerce nav.woocommerce-pagination ul li a:hover, .woocommerce nav.woocommerce-pagination ul li span.current,.zita-menu li.menu-active > a,.main-header .main-header-bar a:hover,.zita-menu .content-social .social-icon li a:hover,.mhdrleftpan .content-social .social-icon a:hover, .mhdrrightpan .content-social .social-icon a:hover{color:{$zita_theme_clr}}
...
//link-hover-color
  $zita_style .= "a:hover,.single .nav-previous:hover:before,.single .nav-next:hover:after,article h2.entry-title a:hover,.zita-menu li a:hover,.main-header .zita-menu > li > a:hover,.zita-menu li.menu-active > a,.main-header .main-header-bar a:hover,.zita-menu .content-social .social-icon li a:hover,.mhdrleftpan .content-social .social-icon a:hover, .mhdrrightpan .content-social .social-icon a:hover{color:{$zita_link_hvr_clr}}";
//body-text-color
  $zita_style .= "body,.zita-site #content .entry-meta{color:{$zita_text_clr}}";
//title-color
  $zita_style .= "article h2.entry-title a,#sidebar-primary h2.widget-title,.woocommerce h1.product_title, .woocommerce-Tabs-panel h2, .related.products h2, section.up-sells h2, .cross-sells h2, .cart_totals h2, .woocommerce-billing-fields h3, .woocommerce-account .addresses .title h3,h1.page-title, h1.entry-title{color:{$zita_title_clr}}";
/*************************************/
//Hamburger COLOR
/*************************************/
...
.menu-custom-html > a button:hover,.read-more .zta-button:hover,#respond.comment-respond #submit:hover,button:hover,[type='submit']:hover,.woocommerce #respond input#submit:hover, .woocommerce a.button:hover,.woocommerce button.button:hover, .woocommerce input.button:hover,.woocommerce #respond input#submit.alt:hover,
 ...
 .woocommerce button.button.alt:hover,
  .woocommerce input.button.alt:hover,.zita-cart p.buttons a:hover,.main-header .main-header-bar .main-header .main-header-bar a.main-header-btn:hover{background:{$zita_button_bg_hvr_clr};
color:{$zita_button_txt_hvr_clr}; border-color:{$zita_button_bg_hvr_clr}}";
/********************/
// Header transparent 
/*********************/
$zita_style .=".mhdrleft.zta-transparent-header .top-header-bar,.mhdrleft.zta-transparent-header .main-header-bar,.mhdrleft.zta-transparent-header .bottom-header-bar,.zita-site .mhdrleft.zta-transparent-header .main-header-bar:before{
...
background:transparent;}";
  //header border
    $zita_theme_clr    = get_theme_mod('zita_theme_clr','#006799');
    $zita_main_hdr_botm_brd = get_theme_mod('zita_main_hdr_botm_brd','0');
...
#content.site-content.fullwidthcontained #container{max-width:{$zita_conatiner_width}px;}";
   ...
   .bottom-header-bar{border-bottom-width:{$zita_bottom_hdr_botm_brd}px;}.bottom-header-bar{border-bottom-color:{$zita_bottom_brdr_clr}}";
    ...
    $zita_abv_ftr_botm_brd = get_theme_mod('zita_abv_ftr_botm_brd','0');
   ...
   .top-footer-bar{border-bottom-width:{$zita_abv_ftr_botm_brd}px;}.top-footer-bar{border-bottom-color:{$zita_above_frt_brdr_clr}}";
    ...
    $zita_btm_ftr_botm_brd = get_theme_mod('zita_btm_ftr_botm_brd','0');
...
/****************/
 ...
 if($zita_blog_dropcap){
  $zita_style .=".blog article .entry-content p:first-child:first-letter{
...
$zita_style .=".blog article .entry-content p:first-child:first-letter{
 ...
 if($zita_single_drop_cap){
  $zita_style .=".single-post article .entry-content p:first-child:first-letter{
                color:{$zita_theme_clr};
                float: left;
                font-family: Georgia;
                font-size: 75px;
