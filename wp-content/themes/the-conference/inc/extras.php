...
function the_conference_breadcrumb(){ 
    ...
    $delimiter  = '<span class="separator"><i class="fas fa-long-arrow-alt-right"></i></span>';
    ...
    if( get_theme_mod( 'ed_breadcrumb', true ) ){
        ...
        if( is_home() ){
        ...
        }elseif( the_conference_is_woocommerce_activated() && ( is_product_category() || is_product_tag() ) ){ //For Woocommerce archive page
            ...
            echo $before . esc_html__( 'Search Results for "', 'the-conference' ) . esc_html( get_search_query() ) . esc_html__( '"', 'the-conference' ) . $after;
        
        }elseif( is_day() ){
            
            echo '<a href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'the-conference' ) ) ) ) . '" itemprop="item">' . esc_html( get_the_time( __( 'Y', 'the-conference' ) ) ) . '</a> ' . $delimiter;
            echo '<a href="' . esc_url( get_month_link( get_the_time( __( 'Y', 'the-conference' ) ), get_the_time( __( 'm', 'the-conference' ) ) ) ) . '" itemprop="item">' . esc_html( get_the_time( __( 'F', 'the-conference' ) ) ) . '</a> ' . $delimiter;
            echo $before . esc_html( get_the_time( __( 'd', 'the-conference' ) ) ) . $after;
        
        }elseif( is_month() ){
            
            echo '<a href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'the-conference' ) ) ) ) . '" itemprop="item">' . esc_html( get_the_time( __( 'Y', 'the-conference' ) ) ) . '</a> ' . $delimiter;
            echo $before . esc_html( get_the_time( __( 'F', 'the-conference' ) ) ) . $after;
        
        }elseif( is_year() ){
            
            echo $before . esc_html( get_the_time( __( 'Y', 'the-conference' ) ) ) . $after;
    
        }elseif( is_single() && !is_attachment() ){
            
            if( the_conference_is_woocommerce_activated() && 'product' === get_post_type() ){ //For Woocommerce single product
            ...
            if( NULL != $post_type ){
                if( get_query_var('paged') ){
                    ...
                    /* translators: 1: paged number */
                    echo $delimiter . $before . sprintf( __('Page %s', 'the-conference'), get_query_var('paged') ) . $after;
                }else{
        ...
        <footer class="comment-meta">
            <div class="comment-author vcard">
        	   <?php 
                    ...
                    printf( __( '<b class="fn" itemprop="creator" itemscope itemtype="http://schema.org/Person">%s<span class="says">says:</span></b>', 'the-conference' ), get_comment_author_link() ); 
                ?>
...
function the_conference_get_home_sections(){
    ...
    // $home_sections = array( 'about', 'stat-counter', 'recent-conference', 'speakers', 'testimonial', 'cta', 'blog', 'contact', 'map' );
...
if( ! function_exists( 'the_conference_ed_author_link' ) ) :
    ...
    */
    function the_conference_ed_author_link(){
        echo '<span class="author-link"><a href="' . esc_url( 'https://raratheme.com/wordpress-themes/the-conference/' ) .'" rel="author" target="_blank">' . esc_html__( ' The Conference', 'the-conference' ) . '</a>' . esc_html__( ' by Rara Theme.', 'the-conference' ) . '</span>';
    }
endif;
