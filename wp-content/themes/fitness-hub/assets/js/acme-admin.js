(function ( $, window, document, undefined ) {
    ...
    at_document.on('click','.media-image-upload', function(e){
        ...
        meta_image_frame.on('select', function(){
            ...
            if( media_image_url_value !== null ){
                ...
                ATREFRESHVALUE(media_image_upload.closest("p"));
            }
    ...
    at_document.ready( function() {
        at_document.on('widget-added widget-updated widget-synced', function( event, widgetContainer ) {
            ATSORTABLE();
        });
        at_document.on('panelsopen', function(e) {
            var dialog = $(e.target);
            ATSORTABLE();
        });
        /*
        ...
        function at_build_hide_unnecessary_meta() {
            var page_template = $('#page_template'),
                lfitness_hub_template_builder_metabox = $('#fitness_hub_template_builder_metabox'),
                fitness_hub_sidebar_layout = $('#fitness_hub_sidebar_layout'),
                fitness_hub_meta_fields = $('#fitness_hub_meta_fields'),
            ...
            if( valueSelected === 'page-templates/template-builder.php' ){
                lfitness_hub_template_builder_metabox.removeClass('hidden');
                fitness_hub_sidebar_layout.addClass('hidden');
                fitness_hub_meta_fields.addClass('hidden');
                postimagediv.addClass('hidden');
            }
            else{
                lfitness_hub_template_builder_metabox.addClass('hidden');
                fitness_hub_sidebar_layout.removeClass('hidden');
                fitness_hub_meta_fields.removeClass('hidden');
