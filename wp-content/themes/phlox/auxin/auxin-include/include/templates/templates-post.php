...
function auxin_wc_add_to_cart( $args = array() ){
                    ...
                    <div class="aux-card-dropdown aux-phone-off <?php echo esc_attr( $args['dropdown_class'] ); ?>">
                        ...
                        <div class="aux-card-checkout">
                            ...
                            <div class="button-wrapper">
                                <a target="_blank" href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="aux-button aux-large <?php echo esc_attr( $args['color_class'] ); ?> aux-uppercase"><span class="aux-overlay"></span><span class="aux-text"><?php esc_attr_e( 'Proceed To Checkout', 'phlox' ); ?></span></a>
                                <div class="clear"></div>
                                <a target="_blank" href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="aux-button aux-large aux-outline aux- <?php echo esc_attr( $args['color_class'] ); ?> aux-outline aux-uppercase"><span class="aux-overlay"></span><span class="aux-text"><?php esc_attr_e( 'View Cart', 'phlox' ); ?></span></a>
                            </div>
                        </div>
                    </div>
                <?php } else { ?>
    ...
    <?php
        ...
        echo apply_filters( 'auxin_shopping_basket', ob_get_clean(), $args );
