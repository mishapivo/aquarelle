 ...
 * @since 1.1.38
 */
function zita_enqueue_google_font($font){
	// Get list of all Google Fonts
	$google_fonts = zita_get_google_fonts_array();
	...
	$subsets        = '';
	$get_subsets    = get_theme_mod( 'zita_font_subsets', array( 'latin' ) );
	...
	// Enqueue style
	wp_enqueue_style( 'zita-google-font-' . $handle, $url, array(), false );
}