...
$sections[] = array(
	'id' => 'example', // Required
	'title' => __( 'Example Section', 'xcel' ), // Required
...
$options['example-text'] = array(
	'id' => 'example-text',
	'label'   => __( 'Example Text Input', 'xcel' ),
	'section' => $section,
	'type'    => 'text',
);
~~~
...
$options['example-checkbox'] = array(
	'id' => 'example-checkbox',
	'label'   => __( 'Example Checkbox', 'xcel' ),
	'section' => $section,
	'type'    => 'checkbox',
	'default' => 0,
);
