...
function mts_Ad_Widget() {
	...
	$widget_ops = array (
		...
		'description' => __('Виджет для 125 х 125 рекламный блок (макс. 6 объявлений)', 'framework')
	);
	...
	// Create the widget
	$this->WP_Widget( 'mts_ad_widget', __('MyThemeShop: 125x125 Ads', 'framework'), $widget_ops, $control_ops );
