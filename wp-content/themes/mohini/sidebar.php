...
$navigation_active = ( 'nav-right-sidebar' == mohini_get_navigation_location() ) ? true : false;
...
?>
<div id="right-sidebar" itemtype="https://schema.org/WPSideBar" itemscope="itemscope" <?php mohini_right_sidebar_class(); ?>>
	<div class="inside-right-sidebar">
		<?php
		/**
		 * mohini_before_right_sidebar_content hook.
		 *
		 */
		do_action( 'mohini_before_right_sidebar_content' );
		...
		/**
		 * mohini_after_right_sidebar_content hook.
		 *
		 */
		do_action( 'mohini_after_right_sidebar_content' );
		?>
