 ...
 */
class Galway_Lite_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Galway_Lite_Radio_Image_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		?> class="np-radio-image" name="<?php echo esc_attr($name);?>"/>
 ...
 * @access public
 */
class Galway_Lite_Customize_Section_Upsell extends WP_Customize_Section {
