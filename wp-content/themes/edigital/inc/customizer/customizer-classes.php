...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    }// end EDigital_Customize_Category_Control
...
/*---------------------------------------------------------------------------------------------------------------*/
    ...
    }// end EDigital_Customize_Switch_Control
...
/*---------------------------------------------------------------------------------------------------------------*/
    ...
    class EDigital_Customize_Control_Radio_Image extends WP_Customize_Control {
        ...
        <?php }
    }// end EDigital_Customize_Control_Radio_Image
...
/*---------------------------------------------------------------------------------------------------------------*/
     ...
     * @access public
     */
    class EDigital_Customize_Section_Upsell extends WP_Customize_Section {
        ...
        <?php }
    }// end EDigital_Customize_Section_Upsell
}