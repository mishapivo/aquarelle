 ...
 *
 * @param null
 * @return array $corporate_plus_about_column_number
 *
 */
if ( !function_exists('corporate_plus_about_column_number') ) :
	function corporate_plus_about_column_number() {
		$corporate_plus_about_column_number =  array(
			1 => __( '1', 'corporate-plus' ),
			2 => __( '2', 'corporate-plus' ),
			3 => __( '3', 'corporate-plus' ),
			4 =>  __( '4', 'corporate-plus' )
		);
		return apply_filters( 'corporate_plus_about_column_number', $corporate_plus_about_column_number );
	}
endif;
        ...
        public function form( $instance ) {
            ...
            <p>
                ...
                <select class="widefat" id="<?php echo $this->get_field_id( 'column_number' ); ?>" name="<?php echo $this->get_field_name( 'column_number' ); ?>" >
			        <?php
			        $corporate_plus_about_column_numbers = corporate_plus_about_column_number();
			        foreach ( $corporate_plus_about_column_numbers as $key => $value ){
				        ?>
