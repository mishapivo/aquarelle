...
;(function ( $, window, document, undefined ) {
    ...
    $.extend( Plugin.prototype, {
        ...
        _readHash: function( arrange ) {
            ...
            if ( !arrange || ( io.filter === oldFilter && ( !this.settings.pagination || io.page === oldPage ) ) ) {
                return;
            }
...
var _Choose = __webpack_require__(12);

var _Choose2 = _interopRequireDefault(_Choose);

var _FontFace = __webpack_require__(45);
...
var _Popover = __webpack_require__(50);

var _Popover2 = _interopRequireDefault(_Popover);

var _Color = __webpack_require__(124);
...
var _Responsive = __webpack_require__(126);
...
var _BaseControl2 = __webpack_require__(1);
...
var Choose = function (_BaseControl) {
    ...
    function Choose(element) {
        ...
        var _this = _possibleConstructorReturn(this, (Choose.__proto__ || Object.getPrototypeOf(Choose)).call(this, element));
...
var _units = __webpack_require__(44);
...
var _controlFactory = __webpack_require__(11);
...
var Container = function (_BaseControl) {
    ...
    function Container(element) {
        ...
        var _this = _possibleConstructorReturn(this, (Container.__proto__ || Object.getPrototypeOf(Container)).call(this, element));
        ...
        .map(function (ctrlElement) {
            return (0, _controlFactory2.default)(ctrlElement);
...
function inputAdapter(inputElement, controlElement) {
...
var _gFonts = __webpack_require__(46);
...
var FontFace = function (_BaseControl) {
    ...
    function FontFace(element) {
        _classCallCheck(this, FontFace);

        // loading element
        var _this = _possibleConstructorReturn(this, (FontFace.__proto__ || Object.getPrototypeOf(FontFace)).call(this, element));
    ...
    _createClass(FontFace, [{
        key: 'onListLoaded',
        value: function onListLoaded(fontsData) {
            var _this2 = this;

            this.selectOptions = '<option value="">Default</option>';
            this.selectOptions += fontsData.items.map(function (font) {
                return '<option value="' + font.family + ':' + font.variants.join(',') + '">' + font.family + '</option>';
            }).join('');
            ...
            if (window.jQuery && window.jQuery.fn.select2) {
                ...
                this.select2.on('change', function () {
                    return _this2.internalSetValue(_this2.select.value);
                });
            } else {
...
var Select = function (_BaseControl) {
    ...
    function Select(element) {
        ...
        var _this = _possibleConstructorReturn(this, (Select.__proto__ || Object.getPrototypeOf(Select)).call(this, element));
...
var Slider = function (_BaseControl) {
    ...
    function Slider(element) {
        ...
        var _this = _possibleConstructorReturn(this, (Slider.__proto__ || Object.getPrototypeOf(Slider)).call(this, element));
...
var _cloneDeep = __webpack_require__(51);
...
var Popover = function (_BaseControl) {
    ...
    function Popover(element) {
        ...
        var _this = _possibleConstructorReturn(this, (Popover.__proto__ || Object.getPrototypeOf(Popover)).call(this, element));
        ...
        if (!has.call(popoverControls, _this.templateId)) {
            // create the control
            popoverControls[_this.templateId] = new _Container2.default(_this.template);
        }

        _this.popoverControl = popoverControls[_this.templateId];
        _this._value = (0, _cloneDeep2.default)(_this.popoverControl.value);
    ...
    _createClass(Popover, [{
        ...
        value: function reset() {
            ...
            this.popoverControl.reset(false);
            this.internalSetValue((0, _cloneDeep2.default)(this.popoverControl.value), emitChange, true);
            this.hasDefaultValue = true;
        }
    }, {
        key: 'locatePopover',
        ...
        value: function openPopover(event) {
            ...
            this.popoverControl.onchange = null;
            this.popoverControl._value = this._value;
            this.popoverControl.update();

            this.templateContainer = this.element.getAttribute('data-container');

            this.popoverControl.onchange = function () {
                _this2.hasDefaultValue = false;
                _this2.internalSetValue((0, _cloneDeep2.default)(_this2.popoverControl.value), true, true);
            };
...
var Stack = __webpack_require__(53),
    ...
    isArray = __webpack_require__(16),
    isBuffer = __webpack_require__(32),
    isMap = __webpack_require__(119),
    isObject = __webpack_require__(3),
    isSet = __webpack_require__(121),
...
var baseIsMap = __webpack_require__(120),
    baseUnary = __webpack_require__(18),
    nodeUtil = __webpack_require__(19);
...
var baseIsSet = __webpack_require__(122),
    baseUnary = __webpack_require__(18),
    nodeUtil = __webpack_require__(19);
...
var Color = function (_BaseControl) {
    ...
    function Color(element) {
        ...
        var _this = _possibleConstructorReturn(this, (Color.__proto__ || Object.getPrototypeOf(Color)).call(this, element));
        ...
        if (window.jQuery && window.jQuery.fn.spectrum) {
            _this.spectrumUI = window.jQuery(_this.colorInput).spectrum({
                ...
                change: function change(color) {
                    var colorValue = color.toRgbString();
...
var Dimension = function (_BaseControl) {
    ...
    function Dimension(element, rootContainer) {
        _classCallCheck(this, Dimension);

        var _this = _possibleConstructorReturn(this, (Dimension.__proto__ || Object.getPrototypeOf(Dimension)).call(this, element, rootContainer));
...
var Responsive = function (_BaseControl) {
    ...
    function Responsive(element) {
        ...
        var _this = _possibleConstructorReturn(this, (Responsive.__proto__ || Object.getPrototypeOf(Responsive)).call(this, element));
        ...
        _this.control = (0, _controlFactory2.default)(controlElement);
        _this._value = { desktop: _this.control.value };
        _this.control.onchange = function () {
            _this._value[_this.devices.value] = _this.control.value;
    ...
    _createClass(Responsive, [{
        ...
        value: function update() {
            ...
            if (Object.hasOwnProperty.call(this._value, this.devices.value)) {
                this.control.value = this._value[this.devices.value];
            } else {
                this.control.value = this._value.desktop;
            }
        ...
        value: function reset() {
            ...
            Object.keys(this._value).forEach(function (key) {
                if (key !== _this2.devices._defaultValue) {
                    delete _this2._value[key];
                }
            });
