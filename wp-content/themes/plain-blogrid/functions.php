<?php 
	 add_action( 'wp_enqueue_scripts', 'plain_blogrid_enqueue_styles' );
...
function plain_blogrid_google_fonts() {

	wp_enqueue_style( 'plain_blogrid-google-fonts', 'http://fonts.googleapis.com/css?family=Noto+Serif:700', false ); 
}

add_action( 'wp_enqueue_scripts', 'plain_blogrid_google_fonts' );



 function plain_blogrid_customize_register( $wp_customize ) {
	$wp_customize->add_section( 'footer_settings', array(
		'title'      => __('Footer Settings','plain-blogrid'),
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_headline_color', array(
		'label'       => __( 'Headline Color', 'plain-blogrid' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_text_color', array(
		'label'       => __( 'Text Color', 'plain-blogrid' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_link_color', array(
		'label'       => __( 'Link Color', 'plain-blogrid' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_border_color', array(
		'label'       => __( 'Border Color', 'plain-blogrid' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_background_color', array(
		'label'       => __( 'Background Color', 'plain-blogrid' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
...
add_action( 'customize_register', 'plain_blogrid_customize_register' );




if(! function_exists('plain_blogrid_customizer_css_final_output' ) ):
	function plain_blogrid_customizer_css_final_output(){
		?>
		...
		.site-info a, .footer-column-three a, .footer-column-three li a, .footer-column-three .widget a, .footer-column-three .sub-arrow { color: <?php echo esc_attr(get_theme_mod( 'footer_link_color')); ?>; }
