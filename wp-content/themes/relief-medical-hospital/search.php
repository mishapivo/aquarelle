    ...
    <div class="container">
        <div class="row">
            ...
            if($layout == 'One Column'){?>
                <div id="firstbox">
                    <?php if ( have_posts() ) : ?>
                        <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s','relief-medical-hospital'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
                    <?php else : ?>
