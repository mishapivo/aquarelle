...
* @return array
*/
function business_gravity_ocdi_import_files() {
	return array(
		array(
		  'import_file_name'             => esc_html__( 'Theme Demo Content', 'business-gravity' ),
		  'categories'                   => array( 'Category 1', 'Category 2' ),
		  'local_import_file'            => trailingslashit( get_template_directory() ) . 'ocdi/business-gravity.xml',
		  'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'ocdi/business-gravity.wie',
		  'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'ocdi/business-gravity.dat',
		  'import_preview_image_url'     => trailingslashit( get_template_directory() ) . 'screenshot.png',
		  'import_notice'                => __( 'Please waiting for a few minutes, do not close the window or refresh the page until the data is imported.', 'business-gravity' ),
		  'preview_url'                  => 'https://www.demo.keonthemes.com/business-gravity',
		),
	);
}
add_filter( 'pt-ocdi/import_files', 'business_gravity_ocdi_import_files' );
