	...
	*{
	...
	<script>
		...
		function auto_fill(){
			...
			// gettings
			var id = url.searchParams.get("yp_page_id");
			var type = url.searchParams.get("yp_page_type");
			var mode = url.searchParams.get("yp_mode");
			var visitor = url.searchParams.get("yp_out");
		...
		function formChange(){
			...
			// Current Settings
			var id = url.searchParams.get("yp_page_id");
			var href = url.searchParams.get("yp_page_href");
			var type = url.searchParams.get("yp_page_type");
			var mode = url.searchParams.get("yp_mode");
			if(url.searchParams.get("yp_out") == null){var visitor = false;}else{var visitor = url.searchParams.get("yp_out");}
