...
function simple_days_custom_font_generate($class_name,$slug_name){
  ...
  generate_css($class_name, 'background', $slug_name.'background_color');
...
generate_css('#f_menu', 'background', 'f_menu_wrap_bg_color');
...
while($i <= 10){
 ...
 $i++;
   ...
   //if($awsome_b == '1'){
echo '.menu_i > li > a:before {font-family:FontAwesome,simpleicons;margin-right:4px}';
   //}
   //if($awsome_a == '1'){
echo '.menu_i > li > a:after {font-family:FontAwesome,simpleicons;margin-right:4px}';
   //}
