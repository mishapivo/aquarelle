...
if (!function_exists('elegant_magazine_ocdi_files')) :
    ...
    function elegant_magazine_ocdi_files()
    {
        ...
        return array(
            array(
                'import_file_name' => esc_html__('Theme Demo Content', 'elegant-magazine'),
                'local_import_file' => trailingslashit(get_template_directory()) . 'demo-content/elegant-magazine.xml',
                'local_import_widget_file' => trailingslashit(get_template_directory()) . 'demo-content/elegant-magazine.wie',
                'local_import_customizer_file' => trailingslashit(get_template_directory()) . 'demo-content/elegant-magazine.dat',
            ),
        );
    }
endif;
