...
jQuery(document).ready(function(){
    ...
    var simpleiconsicon = 'twitter facebook linkedin instagram googleplus youtube messenger whatsapp pinterest vimeo tumblr github codepen amazon digg pocket reddit feedly buffer hatenabookmark line evernote meetup soundcloud rss mail',
        simpleiconsiconArray = simpleiconsicon.split(' '); // creating array
    var simpleiconsicon2 = 'e912 e916 e911 e907 e91a e908 e914 e90e e905 e90f e915 e917 e900 e901 e918 e906 e909 e90c e913 e910 e90b e90d e903 e902 e90a e904',
        simpleiconsiconArray2 = simpleiconsicon2.split(' '); // creating array
    ...
    for (var i = 0; i < simpleiconsiconArray.length; i++) {
        jQuery(".howl-iconpicker .iconsholder").append('<p class="geticonval" data-key="'+simpleiconsiconArray2[i]+'"><i class="simpleicons icon-' + simpleiconsiconArray[i] + '"></i><span>'+simpleiconsiconArray[i]+'</span></p>');
    }
