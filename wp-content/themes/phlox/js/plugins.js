...
;(function ( $, window, document, undefined ) {
    ...
    $.extend(Plugin.prototype, {
        ...
        _checkElementBoundaries: function( etp, wst, calc ) {
            ...
            this.$boundryTarget = $( this.settings.boundryTarget ) || this.$element.parent().eq(0);
...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = "AuxinAnimateAndRedirect",
        defaults = {
            ...
            noAnimate           : '.aux-no-page-animate, .aux-lightbox-btn', // Targets by this class don't animate the page
...
;(function ( $, window, document, undefined ) {
    ...
    $.extend(Plugin.prototype, {
        ...
        update: function() {
            ...
            this._spaceFromTop = this.$element.offset().top - document.documentElement.scrollTop;
