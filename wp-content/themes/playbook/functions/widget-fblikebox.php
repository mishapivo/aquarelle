...
class Facebook_Like_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'facebook_like', 'description' => 'Добавить Facebook Like Box.');

		$control_ops = array('id_base' => 'facebook-like-widget');

		$this->WP_Widget('facebook-like-widget', 'MyThemeShop: FB Like Box', $widget_ops, $control_ops);
	}
	...
	{
		$defaults = array('title' => 'Find us on Facebook', 'page_url' => '', 'width' => '292', 'color_scheme' => 'light', 'show_faces' => 'on', 'show_stream' => false, 'show_header' => false);
