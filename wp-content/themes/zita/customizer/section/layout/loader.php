...
$wp_customize->add_control(new Zita_Misc_Control( $wp_customize, 'zita_pre_loader_more',
        ...
        'section'     => 'zita-pre-loader',
        'type'        => 'custom_message',
        'description' => sprintf( wp_kses(__( 'To know more Go with this <a target="_blank" href="%s">Doc</a> !', 'zita' ), array(  'a' => array( 'href' => array(),'target' => array() ) ) ), esc_url('https://wpzita.com/docs/pre-loader/')),
        'priority'   =>30,
    )));