...
if ( ! function_exists( 'the_conference_customizer_theme_info' ) ) :
	...
	function the_conference_customizer_theme_info( $wp_customize ) {
	    ...
	    $wp_customize->add_section( 'theme_info_section', array(
			'title'       => __( 'Demo & Documentation' , 'the-conference' ),
			'priority'    => 6,
		) );
		...
		$theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'the-conference' ), esc_url( __( 'https://demo.raratheme.com/the-conference/', 'the-conference' ) ), esc_html__( 'Click here.', 'the-conference' ) );

	    $theme_info .= '</p><p>';

	    /* translators: 1: string, 2: documentation url, 3: string */
	    $theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Documentation Link : ', 'the-conference' ), esc_url( 'https://raratheme.com/documentation/the-conference/' ), esc_html__( 'Click here.', 'the-conference' ) );
	...
	$manager->add_section(
		new The_Conference_Customize_Section_Pro(
			...
			array(
				...
				'pro_url'  => 'https://raratheme.com/wordpress-themes/the-conference-pro/'
			)
		)
	);
}