...
function featured_lite_tab_config($theme_data){
    $config = array(
        ...
        'plugin_text' => sprintf(esc_html__('Firstly install recommended plugin Themehunk Customizer.  It will activate homepage sections ( Like : Header, Ribbon, Service, About Us, Team, WooCommerce, Testimonial and Contact Us ).', 'featuredlite'), $theme_data->get( 'Name' )),
        ...
        'docs_button' => esc_html__('Configuration Instructions (with video)', 'featuredlite'),
        ...
        'support_forum' => sprintf(esc_html__('Support Forum', 'featuredlite'), $theme_data->get( 'Name' )),
...
<p>
 <a href="https://www.themehunk.com/product/featured-single-page-wordpress-theme/" target="_blank" class="button button-primary">Check Pro version for more features</a>
</p></div>
<?php }
