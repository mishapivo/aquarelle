...
<div class="single-post">
    <div class="info">
        <ul class="list-inline">
            ...
            <li><i class="fa fa-comments-o"></i> <?php comments_popup_link( __('zero comment','lifestyle-magazine'), __('one comment','lifestyle-magazine'), '% '.__('comments','lifestyle-magazine') ); ?></li>
        </ul>
    </div>
    ...
    <div class="post-content">
        ...
        <div class="bottom-info">
            <a href="<?php the_permalink(); ?>" rel="bookmark" title="" class="btn btn-primary pull-left"><?php esc_html_e('Read More','lifestyle-magazine'); ?> <i class="fa fa-angle-double-right"></i></a>
