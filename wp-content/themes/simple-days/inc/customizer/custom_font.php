...
function Simple_Days_custom_text_color($wp_customize,$name,$section,$default){
  ...
  $wp_customize->add_control( new Simple_Days_Color_Alpha_Custom_Control( $wp_customize, $name.'text_color', array(
...
function Simple_Days_custom_text_hover_color($wp_customize,$name,$section,$default){
  ...
  $wp_customize->add_control( new Simple_Days_Color_Alpha_Custom_Control( $wp_customize, $name.'text_hover_color', array(
...
function Simple_Days_custom_border($wp_customize,$name,$section,$default,$border_angle,$heading_border_style){
  ...
  foreach ($border_angle as $key => $value) {
    ...
    $wp_customize->add_control( new Simple_Days_Color_Alpha_Custom_Control( $wp_customize, $name.'border_'.$key.'_color', array(
      'section'    => $section,
    )));
  }
}
...
function Simple_Days_custom_background_color($wp_customize,$name,$section,$default){
  ...
  $wp_customize->add_control( new Simple_Days_Color_Alpha_Custom_Control( $wp_customize, $name.'background_color', array(
...
function Simple_Days_custom_balloon($wp_customize,$name,$section,$default){
  ...
  $wp_customize->add_control( new Simple_Days_Color_Alpha_Custom_Control( $wp_customize, $name.'balloon_color', array(
