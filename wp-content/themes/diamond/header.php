	...
	<div id="content" class="site-content">
            <?php if ( has_nav_menu( 'second' ) ) : ?>        
                <div class="menu_bar_top">
                    <button class="bt-menu-top">
                        <span class="title-menu-second">
                            <?php
                            $menu_location = 'second';
                    ...
                    <nav class="menu" role="navigation" aria-label="<?php _e( 'Second Menu ', 'diamond' ); ?>">
                        <?php wp_nav_menu( array( 'theme_location' => 'second', 'menu_class' => 'active' ) ); ?>
                    </nav>
            <?php endif; ?>