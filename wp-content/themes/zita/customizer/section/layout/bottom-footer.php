...
$wp_customize->add_setting('zita_footer_bottom_col1_texthtml', array(
        'default'           => __('Copyright | Zita | Powered by Zita','zita'),
        'capability'        => 'edit_theme_options',
...
$wp_customize->add_control(new Zita_Misc_Control( $wp_customize, 'zita_below_footer_more',
        ...
        'section'     => 'zita-bottom-footer',
        'type'        => 'custom_message',
        'description' => sprintf( wp_kses(__( 'To know more Go with this <a target="_blank" href="%s">Doc</a> !', 'zita' ), array(  'a' => array( 'href' => array(),'target' => array() ) ) ), esc_url('https://wpzita.com/docs/below-footer/')),
        'priority'   =>30,
    )));