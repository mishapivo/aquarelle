...
<?php if($content=='text'){?>
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('zita_footer_bottom_col1_texthtml',__('Copyright | Zita | Powered by Zita','zita')));?>
</div>
<?php }elseif($content=='menu'){
...
<?php 
$zita_bottom_footer_widget_layout  = get_theme_mod( 'zita_bottom_footer_widget_layout','ft-wgt-one');
?>	
