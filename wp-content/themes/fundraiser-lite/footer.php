...
<div id="footer-wrapper">
        ...
        <?php } ?>
         <div class="copyright-wrapper">
        	<div class="container">
           		 <div class="copyright-txt"><?php printf('<a target="_blank" href="'.esc_url(FUNDRAISER_LITE_SKTTHEMES_FREE_THEME_URL).'" rel="nofollow">Fundraiser Lite</a>' ); ?></div>
            	 <div class="design-by">
				...
				<div class="footer-social">
                	<div class="social-icons">
                        ...
                        <?php
                        if (!empty($gplus_link)) { ?>
                        <a title="<?php esc_attr__('google-plus','fundraiser-lite'); ?>" class="gp" target="_blank" href="<?php echo esc_url($gplus_link); ?>"></a>
                        <?php } ?>        
                        <?php
