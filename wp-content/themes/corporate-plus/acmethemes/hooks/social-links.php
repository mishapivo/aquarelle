...
if ( !function_exists('corporate_plus_social_links') ) :
    ...
    function corporate_plus_social_links( ) {
        ...
        <ul class="socials text-center init-animate animated fadeInRight">
            ...
            <?php }
            if ( !empty( $corporate_plus_customizer_all_values['corporate-plus-google-plus-url'] ) ) {
                ?>
                <li class="google-plus">
                    <a href="<?php echo esc_url( $corporate_plus_customizer_all_values['corporate-plus-google-plus-url'] ); ?>" data-title="Google Plus" target="_blank"><i class="fa fa-google-plus"></i></a>
                </li>
                <?php
            }
            ?>
