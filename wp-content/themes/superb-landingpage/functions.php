	...
	<div class="wrap about-wrap superb-landingpage-add-css">
		<div>
			...
			<div class="feature-section three-col">
				...
				<div class="col">
					<div class="widgets-holder-wrap">
						<h3><?php echo esc_html__("View our other themes", "superb-landingpage"); ?></h3>
						<p><?php echo esc_html__("Do you like our concept but feel like the design doesn't fit your need? Then check out our website for more designs.", "superb-landingpage"); ?></p>
						<p><a target="blank" href="<?php echo esc_url('https://superbthemes.com/wordpress-themes/', 'superb-landingpage'); ?>" class="button button-primary">
							<?php echo esc_html__("View All Themes", "superb-landingpage"); ?>
						</a></p>
					</div>
				</div>
				<div class="col">
