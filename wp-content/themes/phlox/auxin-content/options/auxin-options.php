...
function auxin_define_options_info( $fields_sections_list ){
    ...
    $options[] = array(
        'title'          => __( 'Logo Text Typography', 'phlox' ),
        'description'    => '',
    ...
    $options[] = array(
        'title'          => __( 'Site Description Typography', 'phlox' ),
        'description'    => '',
    ...
    $options[] = array(
        ...
        'description' => __( 'Enable this option to override defaults typography options.', 'phlox' ),
...
/* ---------------------------------------------------------------------------------------------------
   ...
   $options[] = array(
    ...
    $options[] = array(
        'title'          => __( 'Main Menu Typography', 'phlox' ),
        'description'    => '',
    ...
    $options[] = array(
        'title'          => __( 'Dropdown Menu Typography', 'phlox' ),
        'description'    => '',
    ...
    $options[] = array(
        'title'          => __( 'Page Title Typography', 'phlox' ),
    ...
    $options[] = array(
        'title'          => __( 'Page Subtitle Typography', 'phlox' ),
    ...
    $options[] = array(
        'title'          => __( 'Breadcrumb Typography', 'phlox' ),
    ...
    $options[] = array(
        'title'          => __( 'Breadcrumb Links Typography', 'phlox' ),
    ...
    $options[] = array(
        'title'          => __( 'Breadcrumb Separator Typography', 'phlox' ),
    ...
    $options[] = array(
        'title'         => __( 'Footer Background Image', 'phlox' ),
    ...
    $options[] = array(
        'title'       => __( 'Footer Background Image Position', 'phlox' ),
    ...
    $options[] = array(
        'title'       => __( 'Footer Background Image Size', 'phlox' ),
    ...
    $options[] = array(
        'title'       => __( 'Footer Background Image Repeat', 'phlox' ),
    ...
    $sections[] = array(
        'id'          => 'footer-section-subfooter-typography',
        'parent'      => 'footer-section', // section parent's id
        'title'       => __( 'Sub Footer Typography', 'phlox' ),
        'description' => __( 'Sub Footer Typography', 'phlox' )
    );

    $options[] = array(
        'title'          => __( 'Widget Title', 'phlox' ),
        'id'             => 'subfooter_widget_title_typography',
        'section'        => 'footer-section-subfooter-typography',
        'type'           => 'group_typography',
    ...
    $options[] = array(
        'title'          => __( 'Copyright Typography', 'phlox' ),
    ...
    $options[] = array(
        'title'          => __( 'Theme Attribution Typography', 'phlox' ),
    ...
    $options[] = array(
        'title'          => __( 'Privacy Policy Typography', 'phlox' ),
    ...
    $options[] = array(
        'title'          => __( 'Footer Menu Typography', 'phlox' ),
        'description'    => '',
