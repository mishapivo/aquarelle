...
if( get_locale() == 'ja' ) {
  $wp_customize->add_setting( 'simple_days_kaereba_yomereba',array(
    'default'    => false,
    'sanitize_callback' => 'sanitize_text_field',
    'transport'=>'postMessage',
  ));
  $wp_customize->add_control( 'simple_days_kaereba_yomereba',array(
    'label'   => esc_html__( 'Enable', 'simple-days'),
    'description' => esc_html__('Kaereba and Yomereba CSS', 'simple-days'),
    'section' => 'simple_days_option',
    'type' => 'checkbox',
  ));
