                  ...
                  <div class="summary">
                        ...
                        <ul class="list-inline">
                          ...
                          <?php if( in_array( 'number_of_comments', $post_details ) ) { ?>
                            <li>
                              ...
                              <?php comments_popup_link( __( 'zero comment', 'lifestyle-press' ), __( 'one comment', 'lifestyle-press' ), __( '% comments', 'lifestyle-press' ) ); ?>
                            </li>
                          <?php } ?>
                    ...
                    <?php if( in_array( 'read-more', $post_details ) ) { ?>
                      ...
                      <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark" title="" class="readmore">
                        <?php esc_html_e( 'Read More','lifestyle-press' ); ?>                
                      </a>
                    <?php } ?>
